...
public class Jogo {
	...
	public void comecoJogo(Jogadores jogador) throws IndiceForaDoLimiteException, ManaInsuficienteException {
	    ...
	    if (isJogador1) {
	        ...
	        if ((criatura1 >= 1) && (criatura1 <= 5)) {
	            ...
	            if (jogador.jogavel(criaturaJogador1)) {
	        ...
	        if ((criatura2 >= 1) && (criatura2 <= 5)) {
	            ...
	            if (jogador.jogavel(criaturaJogador2)) {
